"""
DQN — Live Visualisation
=========================
Loads the trained DQN model and renders it in a pygame window.
Slowed down with configurable FPS so you can follow the agent easily.

Usage:
    python scripts/evaluation/watch_dqn.py
    python scripts/evaluation/watch_dqn.py --episodes 5
    python scripts/evaluation/watch_dqn.py --fps 3       # even slower
"""
...
# ── Main ──────────────────────────────────────────────────────────────────────────
def main():
    parser = argparse.ArgumentParser(description="Watch DQN drive")
